                ...
                <div class="form-horizontal">
                    <div class="row mt-2">
                        <div class="col-xs-12 col-xl-12">
                            <div class="row mt-3">
                                <div class="col-xs-6 col-xl-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="text_Enquiryform" onkeydown="upperCaseF(this)" required>
                                    </div>
                                </div>
                                <div class="col-xs-6 col-xl-6">
                                    <label>Advisor Name <span style="color: red;">*</span></label>
                                    <select class="form-control" id="text_Eadvisorname" onkeydown="upperCaseF(this)">
                                        <option value="">SELECT</option>
                                        <option value="1">NEERAJ SWARNKAR (Branch Manager)</option>
                                        <option value="4">MEENA KUSHWAHA</option>
                                    </select>
                                </div>
                            </div>
                            <div class="row mt-3">
                                <div class="col-xs-4 col-xl-4">
                                    ...
                                    <input type="number" class="form-control" id="number_Enquiryform" onkeypress="if(this.value.length==10) return false;" required>
                                </div>
                                <div class="col-xs-4 col-xl-4">
                                    <div class="form-group">
                                        <label class="control-lable">Date <span style="color: red;">*</span></label>
                                        <input type="date" class="form-control" id="date_Enquiryform" value="2023-09-04" required min="2023-09-04">
                                    </div>
                                </div>
                                <div class="col-xs-4 col-xl-4">
                                    <div class="form-group">
                                        <label class="control-lable">Gender <span style="color: red;">*</span></label>
                                        <select class="form-control" id="gender_Enquiryform" onkeydown="upperCaseF(this)">
                                            <option value="">SELECT</option>
                            ...
                            <div class="row mt-3">
                                <div class="col-xs-12 col-xl-12">
                                    ...
                                    <textarea class="form-control" id="description_enquriyform">
                                     </textarea>
                                </div>
                            </div>
                            <div class="row mt-3">
                                <div class="col-xs-12 col-xl-12" id="enqyriyfollowup">
                                    <div class="row">
                                        <div class="col-xs-6 col-xl-6">
                                            ...
                                            <input type="number" class="form-control" id="enquiry_followdays">
                                        </div>
                                        <div class="col-xs-6 col-xl-6">
                                            <label id="enquiry_lableNext">Follow Up Date</label>
                                            <input type="date" class="form-control" id="enquiry_followdate" min="2023-09-04">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group mt-3" id="btn_trial">
                                ...
                                <div class="col-md-12 text-center">
                                    <button type="submit" class="btn btn-primary btn-lg" id="enquiry_btnsave" onclick="myFunctionsave()"><i class="fa fa-save"></i> SAVE</button>
                                    <button type="submit" class="btn btn-primary btn-lg" id="enquiry_btnget" onclick="myFunctionget()"><i class="fa fa-user"></i> GET</button>
                                    <button type="submit" class="btn btn-primary btn-lg" id="enquiry_btntrial" onclick="myFunctiontrial()"><i class="fa fa-tasks"></i> TRIAL</button>
                                </div>
                            </div>
                        ...
                        <div class="div_trial" id="enquiry_div_trial">
                            ...
                            <div class="row">
                                <label class="btn btn-info" onclick="btn_trialCONFIRM()"> Confirm </label>
