<div class="modal modal-warning fade" id="medit{{$members->id}}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-horizontal">
                    <form method="post" class="form-gruop" action="/Members/{{$members->id}}/edit" enctype="multipart/form-data">
                        @csrf
                        <div class="row m-b-8">
                            <div class="col-xs-12 col-xs-12">
                                <div class="row p-2">
                                    <div class="col-xs-12 col-md-6">
                                        <label>Name</label>
                                        <input type="text" value="{{$members->mem_Name}}" class="form-control" id="member_name" name="Member_name" placeholder="Name">
                                    </div>
                                ...
                                <div class="row p-2">
                                    <div class="col-xs-12 col-md-3">
                                        <label>Contact</label>
                                        <input type="number" class="form-control" id="employee_number" name="Member_number" value="{{$members->mem_number}}" placeholder="Mobile Number">
                                    </div>
                                ...
                                <div class="row p-2">
                                    <div class="col-xs-12 col-md-6">
                                        <label>Email</label>
                                        <input type="email" class="form-control" id="Member_email" name="Member_email" value="{{$members->mem_email}}" placeholder="Email">
                                    </div>
                                   
                                    <div class="col-xs-12 col-md-3">
                                    <label>DOB</label>
                                        <input type="date" id="employee_dob" class="form-control" name="Member_dob" value="{{$members->mem_dob}}" placeholder="DOB">
                                    </div>
                                </div>
                                <div class="col-xs-15 col-md-3 p-2">
                                <label>Date o Joining </label>
                                        <input type="date" class="form-control" placeholder="Date of joining" id="date_of_join_emp" name="Date_of_join_mem" value="{{$members->mem_date_join}}">
                                </div>

                                <div class="row p-2">
                                    <div class="col-xs-12 col-md-6">
                                        <label>PAN Number</label>
                                        <input type="text" class="form-control" id="mem_pan_number" name="Mem_pan_number" value="{{$members->mem_pan_num}}" placeholder="PAN Number">
                                    </div>
                                ...
                                <div class="row p-2">
                                    <div class="col-xs-12 col-md-6">
                                        ...
                                        <input type="number" class="form-control" id="employee_aadhar_number" name="Mem_aadhar_number" value="{{$members->mem_aadhar}}" placeholder="Aadhar Number">
                                    </div>
                                    <div class="col-xs-12 col-md-6">
                                        <label>Address</label>
                                        <input type="text" id="employee_address" class="form-control" name="Mem_address" value="{{$members->mem_address}}" placeholder="Address">
                                    </div>
                                </div>
                                ...
                                <div class="row p-2">
                                    <div class="col-xs-12 col-md-7">
                                        ...
                                        <div class="row fullshifts1 mt-3">
                                            <div class="col-md-6">
                                                ...
                                                <input type="time" id="entrytime2" class="form-control" name="Entrytime2" value="{{$members->st_check_in}}">
                                            </div>
                                            <div class="col-md-6">
                                                <label>Check-out</label>
                                                <input type="time" id="exittime2" class="form-control" name="Exittime2" value="{{$members->st_check_out}}">
                                            </div>
                                    ...
                                    <div class="col-xs-12 col-md-5">
                                        ...
                                        <div class="row">
                                            <select name="Mem_status" id="employee_status" class="form-control" value="{{$members->mem_status}}">
